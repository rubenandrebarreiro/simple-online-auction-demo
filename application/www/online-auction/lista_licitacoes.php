<html>
	...
	<body background="img_2.jpg" border="0%" width="100%" height="100%" norepeat text="#8A4117" link="#8A4117" alink="#8A4117" vlink="#8A4117">
		<H2 align=center> Listagem das Licita��es </H2>
			<table border =2 align=center bgcolor="#FFCC99">
				<tr>
					<td><font color="#8A4117"><b> Valor </b></font></td>
					<td><font color="#8A4117"><b> Data de Licita��o </b></font></td>
					<td><font color="#8A4117"><b> Hora de Licita��o </b></font></td>
			...
			<?php
				...
				$r = mysqli_query($con, "select * from licitacoes, utilizadores, artigos where artigos.id_artigo = licitacoes.id_artigo and licitacoes.id_util = utilizadores.id_util");
