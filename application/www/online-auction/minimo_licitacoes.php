	...
	<body background="img_2.jpg" border="0%" width="100%" height="100%" norepeat text="#8A4117" link="#8A4117" alink="#8A4117" vlink="#8A4117">
		<H2 align=center> Valor Mínimo das Licitações </H2>
			...
			<?php
				...
				$r = mysqli_query($con, "select nome_util, nome_artigo, data_licit, hora_licit, valor from licitacoes, artigos, utilizadores where valor=(select min(valor) from licitacoes) and licitacoes.id_artigo=artigos.id_artigo and utilizadores.id_util=licitacoes.id_util");
